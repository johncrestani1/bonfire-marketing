# John Crestani — Podcast Press Sheet
...
| Platform | Handle | URL |
|---|---|---|
| Twitter/X | @johncrestani | https://x.com/johncrestani |
| Instagram | @johncrestani | https://instagram.com/johncrestani |
| YouTube | John Crestani | https://youtube.com/@johncrestani |
| LinkedIn | johncrestani | https://linkedin.com/in/johncrestani |
...
3. **The content creator's AI stack** — What tools creators actually need (STT, image editing, video generation) and why they should run locally, not through SaaS subscriptions.
...
7. **What's next for Bonfire** — Vision for the platform: multi-modal AI, protocol-based content rights (m3m3tic/cr3st4n1), and the creator economy OS.
...
| Installer size | ~2 GB (everything included, zero external dependencies) |
| Build system | Bazel with 1,302 BEP actions, 35 quality gates |
| Platform | Windows 10+ (macOS planned) |

## Headshot

High-resolution headshot available in `press/headshot/`:
- `john-crestani-headshot-1200.jpg` (1200px, for press/web)
- `john-crestani-headshot-400.jpg` (400px, for thumbnails)

## Contact

For podcast booking, press inquiries, and partnership requests:
- Email: john.crestani@gmail.com
- Website: https://bonfireterminal.com
